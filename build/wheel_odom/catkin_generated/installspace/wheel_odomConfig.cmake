...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'wheel_odom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rbtying/wchair/install/${idir}'.  Ask the maintainer 'rbtying <rbtying@todo.todo>' to fix it.")
    endif()
