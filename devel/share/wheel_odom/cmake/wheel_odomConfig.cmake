...
if("TRUE" STREQUAL "TRUE")
  set(wheel_odom_SOURCE_PREFIX /home/rbtying/wchair/src/wheel_odom)
  set(wheel_odom_DEVEL_PREFIX /home/rbtying/wchair/devel)
  ...
  set(wheel_odom_INSTALL_PREFIX /home/rbtying/wchair/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'wheel_odom' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'rbtying <rbtying@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'wheel_odom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rbtying/wchair/src/wheel_odom/${idir}'.  Ask the maintainer 'rbtying <rbtying@todo.todo>' to fix it.")
    endif()
...
set(wheel_odom_EXPORTED_TARGETS "")
